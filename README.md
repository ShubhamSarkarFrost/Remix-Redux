# Remix-Redux
This is my attempt to mimic real life websites using RemixJs &amp; ReduxJs 🎆🎇🎉🎈🎄

## the following mimic of the websites will be created using remix and redux :
| website name | tech stack used | our mimic website |
|:------------|:-------------:|-------------:|
| Bunches(https://www.bunches.co.uk/)      | Item 2        | Item 3       |
| FreshMenu(https://www.freshmenu.com/)      | Data 2        | Data 3       |
| QatarAirways(https://www.qatarairways.com/) |              |               |
| Blinkit(https://blinkit.com/)               |              |                |
| Porters(https://porter.in/)                 |              |                |
| TD Bank(https://www.td.com/)                |              |                |
| Loft33(https://loft33.store/)               |              |                |
